...
namespace ropufu
{
    namespace sequential
    {
        namespace hypotheses
        {
            ...
            {
                using type = adaptive_sprt_star<t_signal_type>;
                using base_type = two_sprt<adaptive_sprt_star<t_signal_type>, t_signal_type>;
            ...
            public:
                explicit adaptive_sprt_star(const model_type& model, double relative_guess_mu_for_null, double relative_guess_mu_for_alt) noexcept
                    : base_type(model),
