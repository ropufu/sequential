...
namespace ropufu
{
    namespace sequential
    {
        namespace hypotheses
        {
            ...
            // ~~ Definitions ~~
            template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>::sprt_type_name[];

            // ~~ Json name definitions ~~
            template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>::jstr_sprt_type[];
