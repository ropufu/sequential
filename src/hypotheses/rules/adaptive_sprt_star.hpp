...
namespace ropufu::sequential::hypotheses
{
    ...
    struct adaptive_sprt_star;

    template <typename t_signal_type, typename t_noise_type, bool t_sync_check>
    void to_json(nlohmann::json& j, const adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>& x) noexcept;
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check>
    void from_json(const nlohmann::json& j, adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>& x);

    template <typename t_process_type, bool t_sync_check = true>
    using adaptive_sprt_star_t = adaptive_sprt_star<typename t_process_type::signal_type, typename t_process_type::noise_type, t_sync_check>;

    template <typename t_signal_type, typename t_noise_type, bool t_sync_check>
    struct adaptive_sprt_star : public two_sprt<
        adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>,
        t_signal_type, t_noise_type, t_sync_check>
    {
        ...
        static constexpr char typename_string[] = "adaptive sprt star";
    ...
    public:
        adaptive_sprt_star() noexcept : base_type() { }

        explicit adaptive_sprt_star(std::size_t id, value_type relative_mu_guess_for_null, value_type relative_mu_guess_for_alt) noexcept
            : base_type(id),
        ...
        /*implicit*/ adaptive_sprt_star(const adaptive_sprt_star<t_other_signal_type, t_other_noise_type, t_other_sync_check>& similar) noexcept
        ...
        adaptive_sprt_star(const nlohmann::json& j, std::error_code& ec) noexcept
            : base_type()
        {
            // Ensure correct type.
    ...
    // ~~ Definitions ~~
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>::typename_string[];

    // ~~ Json name definitions ~~
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>::jstr_typename[];
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>::jstr_id[];
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>::jstr_relative_mu_guess_null[];
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char adaptive_sprt_star<t_signal_type, t_noise_type, t_sync_check>::jstr_relative_mu_guess_alt[];
