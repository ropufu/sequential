...
namespace ropufu::sequential::hypotheses
{
    ...
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check>
    void from_json(const nlohmann::json& j, generalized_sprt_star<t_signal_type, t_noise_type, t_sync_check>& x);
    ...
    struct generalized_sprt_star : public two_sprt<generalized_sprt_star<t_signal_type, t_noise_type, t_sync_check>, t_signal_type, t_noise_type, t_sync_check>
    {
        ...
        static constexpr char typename_string[] = "generalized sprt star";
    ...
    public:
        ...
        generalized_sprt_star(const nlohmann::json& j, std::error_code& ec) noexcept
            : base_type()
        {
            // Ensure correct type.
    ...
    // ~~ Definitions ~~
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char generalized_sprt_star<t_signal_type, t_noise_type, t_sync_check>::typename_string[];

    // ~~ Json name definitions ~~
    template <typename t_signal_type, typename t_noise_type, bool t_sync_check> constexpr char generalized_sprt_star<t_signal_type, t_noise_type, t_sync_check>::jstr_typename[];
