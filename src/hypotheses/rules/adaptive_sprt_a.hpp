...
#ifndef ROPUFU_SEQUENTIAL_HYPOTHESES_ADAPTIVE_SPRT_A_HPP_INCLUDED
#define ROPUFU_SEQUENTIAL_HYPOTHESES_ADAPTIVE_SPRT_A_HPP_INCLUDED
...
#include "adaptive_sprt_a_design.hpp"
...
namespace ropufu::sequential::hypotheses
{
    ...
    struct adaptive_sprt_a;

    template <typename t_process_type>
    using adaptive_sprt_a_t = adaptive_sprt_a<typename t_process_type::signal_type, typename t_process_type::noise_type>;

    template <typename t_signal_type, typename t_noise_type>
    struct adaptive_sprt_a : public two_sprt<
        adaptive_sprt_a<t_signal_type, t_noise_type>,
        t_signal_type, t_noise_type>
    {
        using type = adaptive_sprt_a<t_signal_type, t_noise_type>;
        ...
        using design_type = adaptive_sprt_a_design<value_type>;
    ...
    public:
        adaptive_sprt_a() noexcept : base_type() { }

        /*implicit*/ adaptive_sprt_a(const design_type& design) noexcept
...
#endif // ROPUFU_SEQUENTIAL_HYPOTHESES_ADAPTIVE_SPRT_A_HPP_INCLUDED
